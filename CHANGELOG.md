...
## [0.32.0](https://github.com/deploymenttheory/terraform-provider-jamfpro/compare/v0.31.2...v0.32.0) (2026-01-26)
...
* added device communication settings resource (MDM profile settings) within the gui ([2346a2a](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/2346a2ac7dab14459bfe8c24e46939921c39870b))
...
* added initial implementation of UIE ([aac055b](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/aac055b68c2f0c6f1c6fbab992ac1b5f1ec03a42))
...
* added jamfpro_account_driven_user_enrollment_settings ([f975cd2](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/f975cd2ee39d6f2e203657b50c6ec29c19c0ed0a))
* added plist validation for PayloadName and PayloadDescription ([34b783e](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/34b783e80ad5a6f1283da99ec2b19ed48b47169c))
...
* added resource computer_inventory_collection_settings based on jamf pro api ([f825887](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/f825887148786e24285b30f767f5573208b85348))
...
* added SMTP server resource ([a3bead2](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/a3bead28fd8ae25230712aebeb9cf08f416efb99))
...
* added the enrollment customization resource to the provider with support for text, ldap and sso prestage panes ([0d9a9e7](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/0d9a9e789e86bcfe17c4f0e8e4908da725de1c80))
...
* data source get by id and name enhancements ([65590a5](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/65590a537c61e48577c1b93877d7e9cf149d1f00))
...
* enhance account and account group constructors with privilege validation and add fuzzy matching for invalid privileges ([2be0e7c](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/2be0e7c81da056c714836ba6d8b69ca95cf4cb8c))
...
* migrated computer_checkin resource to client_checkin, fixes for missing api calls and migrated from classic to jamf pro api ([5dc8b12](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/5dc8b126425e4cab1406cfcb6697a70f3116bd42))
...
* removed computer inventory collection resource. replaced by the jamf pro api varient ([07e7606](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/07e76067e05d4ff813ff0ccbf716476b12e0420a))
...
* removed computerinventorycollection. replaced by computerinventorycollectionsettings ([fc25ed5](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/fc25ed58f5c970b2f2919ab9a21690e80358f419))
...
* schema design for user init enrollment ([b2ac189](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/b2ac189b6f9e3b26fd26623aba7bc06c8e1d85e1))
...
* add rp manifest file ([a04ccff](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/a04ccffd61264df47d558267715a6920edc25d2f))
...
* for updating base config ([b48ec0b](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/b48ec0bcc13c089a7a22abcb364d09129c6848c0))
...
* numerous fixes and logic improvements for uie and languages ([b1c4c39](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/b1c4c391673e5e33155a5cbd2d1db3a7a75e1ca5))
* numerous fixes for directory service groups ([3602341](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/36023419c21a68782f5dd288ee9bcbfe8618eb9e))
...
* remove log, trigger RP ([026e946](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/026e94644b58ad28e846679d130a205542717f69))
...
* removed example ([84dc141](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/84dc1411a78201e1452aad97268ce0d07b5a4f00))
* removed example to align with main ([60ab348](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/60ab3484c49b59d7dd396e7d04944b04cb1dda63))
* removed from provider.go ([488e7e2](https://github.com/deploymenttheory/terraform-provider-jamfpro/commit/488e7e241939eeb17088ab0fedae3818788efec1))
