...
// construct constructs a ResourceMacOSConfigurationProfile object from the provided schema data.
func construct(d *schema.ResourceData) (*jamfpro.ResourceMacOSConfigurationProfile, error) {
