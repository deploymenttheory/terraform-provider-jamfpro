	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"timezone": {
				...
				Optional:    true,
				Default:     "UTC",
				Description: "The timezone to be set on the device. Must be a valid timezone string. Set to 'UTC' if unused.",
			},
			"storage_quota_size_megabytes": {
				Type:        schema.TypeInt,
				Optional:    true,
				Default:     1024,
				Description: "The storage quota size in megabytes. Set to 1024 if unused.",
			},
			...
			"preserve_managed_apps": {
				...
				Optional:    true,
				Computed:    true,
				Description: "Controls whether managed apps are preserved during Return to Service operations.",
			},
			"install_apps_during_enrollment": {
				Type:        schema.TypeBool,
				Optional:    true,
				Computed:    true,
				Description: "Controls whether apps are installed during the enrollment process.",
			},
		},
	}
}
