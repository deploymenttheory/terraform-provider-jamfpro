...
Convert `self_service.self_service_category` to sets in `mac_application`. Add schema version 1 with the complete frozen v0 schema and a state upgrader; preserve all unrelated attributes. Singleton and ordered lists remain lists.

No remaining live-test blocker. Tested an unscoped Self Service application; no application was deployed.
